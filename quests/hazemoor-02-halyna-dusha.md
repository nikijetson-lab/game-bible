...
- **Про те, хто створив артефакт.** Моур показує видіння — фрагмент Прадавньої війни. Хтось у військовому обладунку тримає артефакт над водою. Символ на обладунку — **два перехрещені прути, що тримають коло, і в центрі крапля.** Герой впізнає його: така сама печатка була на листі, з якого все почалося в Грейфорді. Тоді це була просто деталь. Тепер — нитка.
