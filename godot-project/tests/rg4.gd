...
func _setup() -> void:
	var p: PackedScene = load("res://scenes/locations/greyford/PortTavernInterior.tscn")
	...
	_cam.global_position = Vector3(4, 3, -4)
...
func _process(_d: float) -> bool:
	...
	if img: img.save_png("res://screenshots/gf_port_new.png"); print("SAVED")
	else: print("NO IMAGE")
	quit(); return true
