...
const GAME_SCENES = {
    ...
    thread_tavern: {
        ...
        text: `У брудному шинку біля причалу бармен протирає склянку. «Руфін? Так, сидів тут три дні тому. Спілкувався з однією дівчиною — куртизанкою на ім'я Касандра. Вона зараз сидить за кутовим столиком.»<br><br>Касандра дивиться на вас із підозрою і не поспішає відкривати душу першому ліпшому Вартівнику.`,
        choices: [
            {
