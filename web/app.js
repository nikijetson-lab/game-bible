...
function resolveFinalWay(way) {
    ...
    if (way === "A") {
        ...
        finalDesc = `
        <strong>Хейзмур</strong> повільно помирає — мертва глина, попіл очерету.<br><br>
        <strong>Тесса</strong> і <strong>Орден Срібних Кинджалів</strong> відбудовують Грейфорд. Лицарі — прикордонна охорона, не кати.<br><br>
        <strong>Лілея</strong> — архіваріус Грейфорда, зберігає пам'ять Ключників.<br><br>
        <strong>Руфін</strong> — вічний пам'ятник гріхів у Чорному Архіві. Дивиться в нікуди.<br><br>
        <strong>Себастьян Марр</strong> — загинув під власним залізом.<br><br>
        <strong>Міа</strong> — оніміла мумія або тиха тінь у мертвому болоті.<br><br>
        ...
        finalSceneId = "ep5_final_A";
    } 
    else if (way === "B") {
        title = "ШЛЯХ Б: ВЕРДИКТ ОЧЕРЕТУ";
        finalDesc = `
        <strong>Хейзмур</strong> живе і розширюється. Очеретяні ліси поглинули околиці Грейфорда.<br><br>
        <strong>Тесса</strong> і <strong>Залізні Кинджали</strong> тримають глуху оборону під стінами Валькорна. Офіційно визнано суверенітет болота.<br><br>
        <strong>Лілея</strong> живе на межі Грейфорда і дикого очерету — допомагає людям.<br><br>
        <strong>Руфін</strong> — стоїть біля вівтаря каплиці на кордоні з болотом. Дивиться у вікно.<br><br>
        <strong>Себастьян Марр</strong> — загинув.<br><br>
        <strong>Міа</strong> — зникла в непрохідному тумані.<br><br>
        Герой несе рубці на руках і відновлену людську душу — дорога туди, де немає очеретяного шепоту.`;
        
        adjustReputation("muri", 50);
        adjustReputation("greyford", -50);
        finalSceneId = "ep5_final_B";
    } 
    else {
        title = "ШЛЯХ В: ПАКТ КЛЮЧНИКА";
        finalDesc = `
        <strong>Хейзмур</strong> — дике й небезпечне, але в рівновазі. Не розширюється.<br><br>
        <strong>Тесса</strong> і <strong>Орден Рівноваги</strong> стережуть срібну лінію ліхтарів. Крихкий, але працюючий баланс.<br><br>
        <strong>Лілея</strong> — дипломат і Ключник Пакту. Стежить за кожним гвинтом домовленості.<br><br>
        <strong>Руфін</strong> — сидить під вербою в саду Ратуші. Дивиться на ліхтарі.<br><br>
        <strong>Себастьян Марр</strong> — живий, відійшов від влади. Спостерігає з тіней палацу.<br><br>
        <strong>Міа</strong> — поважає Пакт, залишається в болоті. Стримана повага.<br><br>
        ...
        finalSceneId = "ep5_final_C";
    }
    
    const sceneId = `ep4_bridge_ending_${way.toLowerCase()}`;
    window.GAME_SCENES[sceneId] = {
        title: `🏆 СТАН СВІТУ: ${title}`,
        isChapterEnding: true,
        text: `
        <span class="quest-tag" style="color: var(--accent-gold);">ЕПІЛОГ</span>
