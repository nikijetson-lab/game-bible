...
func _init() -> void:
	_shots = [
		...
		{"s": "res://scenes/locations/greyford/CraftsmenQuarter.tscn", "c": Vector3(-2,2.5,-3), "l": Vector3(0,1.5,2), "o": "gf_crafts"},
		{"s": "res://scenes/locations/greyford/PortTavernInterior.tscn", "c": Vector3(4,3,-4), "l": Vector3(0,1.5,0), "o": "gf_port"},
		{"s": "res://scenes/locations/greyford/GreyfordGate.tscn", "c": Vector3(0,3,-7), "l": Vector3(0,2,0), "o": "gf_gate"},
		{"s": "res://scenes/locations/greyford/AlteyaHiddenRoom.tscn", "c": Vector3(-4,2,0), "l": Vector3(0,1.2,-1), "o": "gf_alteya"},
		{"s": "res://scenes/locations/greyford/RufinRoom.tscn", "c": Vector3(-2,1.8,-1), "l": Vector3(0,1,0), "o": "gf_rufin"},
		{"s": "res://scenes/locations/greyford/GreyfordStreet.tscn", "c": Vector3(0,2.5,-5), "l": Vector3(0,1.5,0), "o": "gf_street"}
	]
	call_deferred("_next")
