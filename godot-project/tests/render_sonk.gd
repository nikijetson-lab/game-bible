...
func _setup() -> void:
	var p: PackedScene = load("res://scenes/locations/sonk_ferry/SonkFerry.tscn")
	...
	_cam.global_position = Vector3(0, 6, -40)
	_cam.look_at(Vector3(0, 1, 0), Vector3.UP)
...
func _process(_d: float) -> bool:
	...
	get_root().get_viewport().get_texture().get_image().save_png("res://screenshots/sonk_ferry_overview.png")
