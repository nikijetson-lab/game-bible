...
]; var _idx:=0; var _s:Node
func _init() -> void: call_deferred("_next")
func _next() -> void:
	if _s: _s.queue_free()
	var paths := ["res://scenes/locations/greyford/TavernInterior.tscn","res://scenes/locations/greyford/TavernInterior.tscn","res://scenes/locations/greyford/GreyfordGate.tscn","res://scenes/locations/greyford/AlteyaHiddenRoom.tscn"]
