...
- **Хто послав артефакт** — **Орден Семи Кинджалів**. Символ на обладунку у видінні Моура — їхній знак: два перехрещені прути, що тримають коло, з краплею в центрі. Той самий, що на печатці листа з Грейфорда. Повна відповідь — у Валькорні, Епізод 2.
