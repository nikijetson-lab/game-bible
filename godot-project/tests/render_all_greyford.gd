extends SceneTree
var _cam: Camera3D; var _frames := 0; var _scenes := [
...
func _next() -> void:
	...
	var centers := [Vector3(0,1.6,1.5), Vector3(0,1.6,0), Vector3(3,1.6,0), Vector3(0,1.6,0), Vector3(0,1.6,-1.35)]
...
var _names := ["tavern","crafts","port","gate","alteya"]
