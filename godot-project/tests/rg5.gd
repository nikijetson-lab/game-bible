...
func _setup() -> void:
	var p: PackedScene = load("res://scenes/locations/greyford/RufinRoom.tscn")
	...
	_cam.global_position = Vector3(2, 2, -2)
	_cam.look_at(Vector3(0, 1.2, -0.5), Vector3.UP)
...
func _process(_d: float) -> bool:
	...
	if img: img.save_png("res://screenshots/gf_rufin_new.png"); print("SAVED")
	else: print("NO IMAGE")
	quit(); return true
