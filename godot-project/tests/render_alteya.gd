...
func _setup() -> void:
	var p: PackedScene = load("res://scenes/locations/greyford/AlteyaHiddenRoom.tscn")
	...
	_cam.global_position = Vector3(0, 1.6, 1.5)
	_cam.look_at(Vector3(0, 1.0, -1.35), Vector3.UP)
...
func _process(_d: float) -> bool:
	...
	get_root().get_viewport().get_texture().get_image().save_png("res://screenshots/alteya_room.png")
