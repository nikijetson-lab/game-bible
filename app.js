...
class AudioManager {
    constructor() {
        ...
        this.trackAudio.volume = 0.3;

        this.atmosAudio = new Audio();
        this.atmosAudio.loop = true;
        this.atmosAudio.volume = 0.2;
...
function adjustReputation(faction, delta) {
    // Аліаси старих ключів → нові (для сумісності з quests-data.js)
...
document.getElementById("audio-toggle-btn").addEventListener("click", () => {
    // synth.toggleMute(); — вимкнено, MP3 заміняють синтезатор
