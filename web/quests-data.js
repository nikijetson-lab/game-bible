...
window.GAME_SCENES = {
    ...
    // --- ЕПІЗОД 2: ВАЛЬКОРН ТА ТІНІ ХЕЙЗМУРУ ---
    ep2_travel: {
        title: "Подорож крізь Туманний ліс",
        text: `Ви йдете вузькою стежкою між високими болотяними соснами. Туман густішає, повітря наповнене запахом гнилої хвої та торфу. Ви чуєте шепіт очерету та бачите дивні тіні, що ковзають поміж дерев. Раптом ви помічаєте постать із жовто-зеленими очима та вертикальними зіницями — це **Міа**, дочка шамана Мурі. Вона вкрита захисними болотяними гліфами.`,
        choices: [
            {
                text: "🗣️ Заговорити з Мією про небезпеки болота",
                action: () => {
                    addToLog("Міа шипить: «Чужинцю, туман ховає ікла. Візьми мазь, або станеш їжею.»", "success");
                    addItem("🌿 Болотяна мазь");
                    adjustReputation("muri", 15);
                    goScene("ep2_muri_encounter");
                }
            },
            {
                text: "⚔️ Проігнорувати її та йти далі",
                action: () => {
                    addToLog("Ви гордо йдете далі, але туман згущується...", "system");
                    goScene("ep2_monster_ambush");
                }
            }
        ]
    },
    ep2_muri_encounter: {
        title: "Зустріч з Мурі",
        text: `Міа наносить вам на обличчя захисні гліфи з болотяної мазі. «Тепер Тварюка не відчує твого страху,» — каже вона. Ви продовжуєте шлях разом і незабаром чуєте важке дихання. З темряви виповзає **Болотяна Тварюка**! Але завдяки мазі вона дезорієнтована.`,
        choices: [
            {
                text: "⚔️ Використати перевагу і напасти!",
                action: () => {
                    startCombat("Сліпа Болотяна Тварюка", 30, 5, () => goScene("ep2_victory"), () => goScene("death"));
                }
            },
            {
                text: "🌿 [Слідопит] Обійти монстра стороною",
                visible: () => window.playerState.doctrines.pathfinder >= 1,
                action: () => {
                    addToLog("Ви безшумно обійшли монстра, зберігши сили.", "success");
                    adjustReputation("muri", 10);
                    goScene("ep2_victory_peaceful");
                }
            }
        ]
    },
    ep2_monster_ambush: {
        title: "Засідка в Тумані",
        text: `Без захисних гліфів ваш запах привертає увагу хижака. З темряви раптово вистрибує розлючена **Болотяна Тварюка** (Swamp Beast)! Вона блокує вам дорогу!`,
        choices: [
            {
                text: "⚔️ Приготуватись до важкого бою!",
                action: () => {
                    startCombat("Болотяна Тварюка", 60, 15, () => goScene("ep2_victory"), () => goScene("death"));
                }
            }
        ]
    },
    ep2_victory: {
        title: "Кривава Перемога",
        text: `Ви здолали Болотяну Тварюку в бою. Її тіло з шипінням розчиняється в торф'яному мулі. У слизі ви знаходите пульсуючу болотну органіку.<br><br>Ви виходите до кам'яних околиць **Валькорна**. Біля стародавнього Чорного Архіву ви зустрічаєте командувача Себастьяна Марра та Тессу. Вони тримають скриньку з Печаткою.`,
        choices: [
            {
    ...
    ep2_victory_peaceful: {
        title: "Шлях Тіні",
        text: `Ви уникли зайвого кровопролиття. Міа схвально киває і розчиняється в тумані.<br><br>Ви виходите до кам'яних околиць **Валькорна**. Біля стародавнього Чорного Архіву ви зустрічаєте командувача Себастьяна Марра та Тессу. Вони тримають скриньку з Печаткою.`,
        choices: [
            {
                text: "Підійти до Себастьяна Марра",
                action: () => {
    ...
    // --- ЕПІЗОД 3: ГЛИБОКЕ БОЛОТО ТА СЕРЦЕ БОЛОТА ---
    ep3_swamp: {
        ...
        choices: [
            {
                ...
                action: () => {
                    addToLog("Протиотрута діє миттєво. Дихання стає рівним.", "success");
                    goScene("ep3_heart");
                }
            },
            {
    ...
    ep3_heart: {
        title: "Серце Болота",
        text: `Ви дісталися Серця Болота. З гнилої води піднімаються древні руїни Святої Вей. Серед них ви знаходите лігво шамана Мурі. Його вбито, але поряд ви бачите ритуальний вівтар з підказками про справжню природу Печатки.`,
        choices: [
            {
                text: "🔍 Оглянути вівтар",
                action: () => {
                    window.playerState.clues.shaman = true;
                    addToLog("Ви знаходите стародавні записи. Печатка не стримує Моур — вона живить його!", "success");
                    goScene("ep3_meeting_lileya");
                }
            },
            {
                text: "🏃 Продовжити шлях не затримуючись",
                action: () => goScene("ep3_meeting_lileya")
            }
        ]
    },
    ep3_meeting_lileya: {
        ...
        choices: [
            {
                text: "«Я знаю правду про Печатку. Вона живить Моур.» (Секретний шлях)",
                visible: () => window.playerState.clues.shaman === true,
                action: () => {
                    addToLog("Лілея затримує дихання: «То ти бачиш істину...»", "success");
                    window.playerState.clues.truth = true;
                    goScene("ep4_bridge");
                }
            },
            {
    ...
    ep4_bridge: {
        ...
        choices: [
            ...
            {
                text: "🔥 «Знищити Печатку та вивільнити Моур (Секретний Шлях)»",
                visible: () => window.playerState.clues.truth === true,
                action: () => resolveFinalWay("SECRET")
            }
        ]
    },
